...
import com.example.PageStorage.naverbook.BookApiClient;
import com.example.PageStorage.naverbook.BooksResponseDto;
...
@RestController
public class ChatGptControllert {
...
//        ClientResponse clientResponse = ClientResponse.builder().choices(chatGptResponse.getChoices()).build();
        ...
        // ChatGptResponse 객체에서 choices를 가져옵니다.
        List<ChatGptResponse.Choice> choices = chatGptResponse.getChoices();

        // 가져온 choices를 순회하면서 content를 추출하여 리스트에 담습니다.
        ...
        // 추출한 content를 사용하여 ClientResponse 객체를 생성합니다.
