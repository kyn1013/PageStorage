//package com.example.PageStorage.gpt.service;
//
//import com.example.PageStorage.gpt.config.ChatGPTConfig;
//import com.example.PageStorage.gpt.dto.ChatCompletionDto;
////import com.example.PageStorage.gpt.dto.CompletionDto;
//import com.example.PageStorage.gpt.dto.ChatRequestMsgDto;
//import com.example.PageStorage.gpt.dto.Q;
...
//     */
//    @Override
//    public Map<String, Object> prompt(Q q) {
//        log.debug("[+] 신규 프롬프트를 수행합니다.");
//        List<ChatRequestMsgDto> msg = new ArrayList<>();
//        msg.add(ChatRequestMsgDto.builder()
